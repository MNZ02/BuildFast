    ...
    return (
        <section className="bg-white-off py-16">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="text-gray-title text-5xl font-normal mb-12 text-[#4A2511] py-6">
                    About Us
                </h2>
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-x-16 gap-y-10 items-start"> {/* Adjusted grid-cols and items-start */}
                    ...
                    <div className="flex flex-col space-y-16 justify-center items-center"> {/* Increased space-y */}
                        ...
                        {/* Quote Text */}
                        <p className="text-gray-text leading-relaxed font-sans font-semibold text-2xl"> {/* Added leading-relaxed for better line height */}
